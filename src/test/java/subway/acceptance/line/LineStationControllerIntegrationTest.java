...
public class LineStationControllerIntegrationTest {
    ...
    class 노선에_역을_추가할_떄 {
        ...
        void 기준역에_대해_요청한_방향으로_추가된다() {
            ...
            노선에_포함된_N번째_구간을_검증한다(
                    노선_조회_응답, 0, "말랑역", "경유역", 4);
            노선에_포함된_N번째_구간을_검증한다(
                    노선_조회_응답, 1, "경유역", "오리역", 6);
        }
        ...
        void 구간이_이미_다른_노선에_존재하며_해당_노선과_거리가_일치하지_않는_경우_예외() {
            ...
            역_생성_요청("역2");
            역_생성_요청("역3");
            노선_생성_요청("1호선", "역1", "역2", 1, 0);
            노선_생성_요청("2호선", "역2", "역3", 2, 0);
    ...
    class 노선에서_역을_제거할_때 {
        ...
        void 노선을_재배치한다() {
            ...
            역_생성_요청("선릉역");
            역_생성_요청("사당역");
            final UUID 노선_아이디 = 노선_생성하고_아이디_반환(
                    "1호선", "잠실역", "선릉역", 10, 0);
