...
public class PathControllerIntegrationTest {
    ...
    class 최단경로_조회_시 {
        ...
        void 최단경로를_조회한다() {
            ...
            최단경로의_요금은(장암역에서_잠실역_최단경로_정보, 1950 + 700);
            ...
            최단경로의_요금은(잠실역에서_장암역_최단경로_정보, 1950 + 700);
        ...
        void 경로가_없는_경우_예외이다() {
            역들을_생성한다("장암", "도봉산", "수락산", "건대입구", "강남구청", "잠실", "구의", "왕십리");
            노선_생성_요청("7호선", "장암", "도봉산", 5, 0);
            노선에_역_추가_요청("7호선", "도봉산", "수락산", 10);
            노선에_역_추가_요청("7호선", "수락산", "건대입구", 5);

            노선_생성_요청("2호선", "잠실", "구의", 5, 0);
